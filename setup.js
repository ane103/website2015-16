...
var graph = {
	...
	{'name':'exhibits','x':width/2-50,'y':height/2, 'id':'exhibits', 'url':'exhibit.html'},
	{'name':'blogs','x':width/2-30,'y':height/2-50, 'id':'blogs', 'url':'webpres_mainpage.html'},
	{'name':'casting','x':width/2-30,'y':height/2+50, 'id':'casting', 'url':'casting_recipe.html'},
	{'name':'lab','x':width/2+50,'y':height/2-30, 'id':'lab', 'url':'presentationTemplate.html'},
	{'name':'paper','x':width/2+50,'y':height/2+30,'id':'paper', 'url':'term_papers.html'}
    ],
    "links":[
	{"source":0,"target":1},
	{"source":0,"target":2},
